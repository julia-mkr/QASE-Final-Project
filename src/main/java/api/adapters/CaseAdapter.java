...
public class CaseAdapter extends BaseAdapter {
    ...
    @Step("Create a test case with the title: '{testCase.testCaseTitle}' using the project code: '{projectCode}'")
    ...
    @Step("Get a specific test case by id: '{id}' using the project code: '{projectCode}")
